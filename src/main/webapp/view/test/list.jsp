            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-8">
                    <div class="btn-group hidden-xs" role="group">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" id="update" name="test/upload.do">
                ...
                <div class="col-sm-4">
                    <input class="form-control" id="search" name="name" value="${name}" type="text" placeholder="查询内容 回车搜索"/>
                </div>
                <!-- ------------按钮组 end------------ -->
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <c:forEach var="e" items="${page.list }" varStatus="v">
                        <tr>
                            ...
                            <td>${e.age }</td>
                            <td>
                            <zhg:show value="${e.sex}" codeTp="sex"></zhg:show>
                            </td>
                            <td>
                                    <fmt:formatDate value="${e.birthday }" pattern="yyyy-MM-dd"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
